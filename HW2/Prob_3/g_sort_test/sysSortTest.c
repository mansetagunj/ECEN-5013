...
int main()
{
	...
	printf("\n");
    printf("Invoking 'g_ksort' system call. POSITIVE\n");
    ...
    if(ret_status == 0) 
    {
		...
		printf("Last 10 entries dmesg log \n");
		printf("---------------------------------------\n");
	...
	printf("\n");
    printf("Invoking 'g_ksort' system call. NULL BUFFER\n");
	...
	printf("\n");
	printf("Invoking 'g_ksort' system call. INVALID BUFFER SIZE\n");
	...
	printf("\n");
    printf("Invoking 'g_ksort' system call. INVALID SIZE\n");
	...
	printf("\n");
    printf("Invoking 'g_ksort' system call. OUTBUFFER NULL\n");
